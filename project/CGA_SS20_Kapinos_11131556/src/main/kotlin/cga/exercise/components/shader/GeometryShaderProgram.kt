...
open class GeometryShaderProgram (vertexShaderPath: String, geometryShaderPath: String, fragmentShaderPath: String) : ShaderProgramType(){

    protected var programID: Int = 0
    protected var vShader: Int = 0;
    protected var gShader: Int = 0;
    ...
    init {
        ...
        gShader = GL20.glCreateShader(GL32.GL_GEOMETRY_SHADER)
        if (gShader == 0)
            if (fShader == 0) {
