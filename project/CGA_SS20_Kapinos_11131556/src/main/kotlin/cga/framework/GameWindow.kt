...
//
//       // return GLFW.glfwGetKey(m_window, key) == GLFW.GLFW_REPEAT
//       // return GLFW.glfwGetKey(m_window, key) == GLFW.GLFW_RELEASE
//    }
    fun getKeyStatePress(key: Int): Boolean {
        return GLFW.glfwGetKey(m_window, key) == GLFW.GLFW_PRESS

    }
    fun getKeyStateRepeat(key: Int): Boolean {
        return GLFW.glfwGetKey(m_window, key) == GLFW.GLFW_REPEAT

    }
    fun getKeyStateRelease(key: Int): Boolean {
        return GLFW.glfwGetKey(m_window, key) == GLFW.GLFW_RELEASE
